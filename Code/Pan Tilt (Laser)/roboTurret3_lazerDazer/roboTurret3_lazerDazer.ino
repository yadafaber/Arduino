...
const int PAN_MIN = 0;     // minimum pan servo range, value should be between 0 and 180 and lower than PAN_MAX
const int PAN_MAX = 180;    // maximum pan servo range, value should be between 0 and 180 and more than PAN_MIN

const int TILT_MIN = 0;    // minimum tilt servo range, value should be between 0 and 180 and lower than TILT_MAX
